...
//#region node_modules/.nitro/vite/services/ssr/assets/examples-Dm8auFTu.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					" ",
					"list — original Lattice notes for the problems those books do not cover. Every page uses the four-step framework: scope, sketch, deep dive, wrap."
				]
			}),
