...
import { s as AppLink } from "./router-BHU5cr3E.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/resources-Dfa6iWWB.js
var import_jsx_runtime = require_jsx_runtime();
var awesomeRepo = {
	title: "awesome-system-design-resources",
	href: "https://github.com/ashishps1/awesome-system-design-resources",
	blurb: "Ashish Pratap Singh's public list: 30 core concepts, Easy/Medium/Hard interview problems, papers, and channels. Lattice uses it as source 6 — original notes here, the list for everything else."
};
var awesomeProblems = [
	{
...
var resources = [
	...
	},
	{
		...
		blurb: "Thirty interview prompts from CAP to YouTube. Each maps onto an example or concept page here.",
		kind: "roadmap"
	},
	{
	...
	},
	{
		...
		blurb: "Scale-from-zero, estimation, the four-step framework, then rate limiter through Google Drive. 16 chapters.",
		kind: "book"
	},
	{
		...
		blurb: "Proximity, maps, Kafka-like queues, metrics, ads, hotels, S3, wallets, matching engines. 13 chapters.",
		kind: "book"
	},
	{
	...
	},
	{
		...
		blurb: "The authors' newsletter and diagrams. Use alongside the books, not as a substitute for working a design on paper.",
		kind: "course"
	},
	{
		title: "Amazon Dynamo paper",
		href: "https://www.allthingsdistributed.com/files/amazon-dynamo-sosp2007.pdf",
		blurb: "Consistent hashing, sloppy quorum, gossip, hinted handoff — the primary source behind the KV-store example.",
		kind: "article"
	},
	{
...
var BANDS = [
	{
		id: "easy",
		label: "Easy",
		hint: "Warm-ups and building blocks."
	},
	{
		id: "medium",
		label: "Medium",
		hint: "The product designs most loops actually ask."
	},
	{
		id: "hard",
		hint: "Realtime, money-adjacent, or a moving fleet.",
		label: "Hard"
	}
];
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Where this atlas points"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-3 max-w-2xl text-[15px] leading-7 text-muted",
				children: "Lattice is original teaching notes inspired by public system-design practice and the chapter maps of Alex Xu's books — not a reproduction of the books. Buy them. Then use the labs here to keep the diagrams in your hands. Source 6 is the public awesome list: problems, papers, and channels folded into this page."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
				className: "mt-8 space-y-3",
				children: resources.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					href: r.href,
					target: "_blank",
					rel: "noreferrer",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							}), r.kind === "repo" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[11px] uppercase tracking-[0.14em] text-ok",
								children: "Source 6"
							}) : null]
						}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: "Interview problems from the awesome list"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								...
								children: "ashishps1/awesome-system-design-resources"
							}),
							". Where Lattice has a worked page, open that. Otherwise jump to the public walkthrough the list points at."
						]
					}),
					BANDS.map((band) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
									...
									children: items.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProblemCard, { problem: p }) }, p.title))
								})
							]
						}, band.id);
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: "Must-read papers"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 max-w-2xl text-sm text-muted",
						children: "The distributed-systems canon from the same list. Dynamo and Chubby pair with Lattice's KV-store and lock examples."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						className: "mt-5 space-y-2",
						children: awesomePapers.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExtLink, {
							title: l.title,
							href: l.href,
							blurb: l.blurb
						}) }, l.href))
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					className: "mt-5 space-y-2",
					children: awesomeArticles.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExtLink, {
						title: l.title,
						href: l.href,
						blurb: l.blurb
					}) }, l.href))
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: awesomeChannels.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExtLink, {
						title: l.title,
						href: l.href,
						blurb: l.blurb
					}) }, l.href))
...
function ProblemCard({ problem }) {
	const inner = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		}), problem.lattice ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "shrink-0 text-[11px] uppercase tracking-[0.14em] text-ok",
			children: "In Lattice"
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "size-4 shrink-0 text-faint" })]
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: "mt-1 text-sm leading-6 text-muted",
		children: problem.blurb
	})] });
	if (problem.lattice) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppLink, {
...
function ExtLink({ title, href, blurb }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "mt-1 text-sm leading-6 text-muted",
			children: blurb
		})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "mt-0.5 size-4 shrink-0 text-faint" })]
	});
}
//#endregion
