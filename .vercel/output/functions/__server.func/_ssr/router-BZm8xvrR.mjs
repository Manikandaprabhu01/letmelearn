...
import { n as getExample, t as examples } from "./examples-BE68fLeU.mjs";
import { n as hldConcepts, t as getHld } from "./hld-C3aOoHR-.mjs";
import { n as lldConcepts, t as getLld } from "./lld-BUARFLCU.mjs";
import { n as playgrounds, t as getPlayground } from "./playgrounds-BbpE6ZvK.mjs";
import { n as require_react } from "../_libs/@radix-ui/react-compose-refs+[...].mjs";
import { B as require_jsx_runtime, _ as createFileRoute, b as useRouter, d as useCanGoBack, f as useRouterState, g as lazyRouteComponent, h as Outlet, l as Scripts, m as createRouter, u as HeadContent, v as createRootRoute, y as Link, z as notFound } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
import { i as Menu, l as ArrowLeft, n as TriangleAlert, r as Search, t as X } from "../_libs/lucide-react.mjs";
import { a as union, i as string, n as number, r as object, t as literal } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/catalog-Ce7MSQK6.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-BZm8xvrR.js
...
function BackButton({ compact = false }) {
	const router = useRouter();
	const canGoBack = useCanGoBack();
	const pathname = useRouterState({ select: (s) => s.location.pathname });
	const nowhere = pathname === "/" && !canGoBack;
	const onBack = () => {
		if (nowhere) return;
		if (canGoBack) {
			router.history.back();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "size-4" }), compact ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "sr-only",
			children: "Back"
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "sticky top-0 z-30 flex h-14 items-center justify-between gap-2 border-b border-border bg-bg/90 px-3 backdrop-blur-sm lg:hidden",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex min-w-0 items-center gap-1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BackButton, { compact: true }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/",
						className: "flex min-w-0 items-center gap-2 text-fg",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogoMark, { className: "size-6 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "sticky top-0 z-20 hidden h-12 items-center border-b border-border bg-bg/90 px-5 backdrop-blur-sm lg:flex",
...
var styles_default = "/assets/styles-5xUS-aB3.css";
function NotFound() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
...
var $$splitComponentImporter$5 = () => import("./hld-wNzBg3IQ.mjs");
var Route$5 = createFileRoute("/hld/")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("../_slug-BFVM9TTk.mjs");
...
var $$splitComponentImporter$3 = () => import("./lld-DZuIVad-.mjs");
var Route$3 = createFileRoute("/lld/")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("../_slug-BoDyuONy.mjs");
...
var $$splitComponentImporter = () => import("../_slug-DmmfyED1.mjs");
