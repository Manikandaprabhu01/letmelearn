  ...
  return (
    <main className="px-5 py-10 sm:px-8 lg:px-12">
      ...
      <p className="mt-3 max-w-2xl text-[15px] leading-7 text-muted">
        Worked interviews in three collections. Volume 1 and 2 follow Alex Xu. Source 6 is the
        public{" "}
        <a
        ...
        list — original LetMeLearn notes for the problems those books do not cover. Every page uses
        the four-step framework: scope, sketch, deep dive, wrap. Every example now opens with a full
        architecture board and a numbered walkthrough of the data path.
      </p>
      ...
      <p className="mt-1 max-w-2xl text-sm text-muted">
        Auth, Instagram, Spotify, Netflix, Uber, Docs, Zoom, locks — problems the GitHub list is
        famous for, written here as original teaching notes. The full Easy / Medium / Hard index
        lives on Sources.
      </p>
      <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {awesome.map((e) => (
