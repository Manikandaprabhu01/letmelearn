  ...
  return (
    <main className="px-5 py-10 sm:px-8 lg:px-12">
      ...
      <p className="mt-3 max-w-2xl text-[15px] leading-7 text-muted">
        Lattice is original teaching notes inspired by public system-design practice and the chapter maps of Alex Xu's
      ...
      <section className="mt-16">
        ...
        <p className="mt-2 max-w-2xl text-sm text-muted">
          The distributed-systems canon from the same list. Dynamo and Chubby pair with Lattice's KV-store and lock
          examples.
        </p>
  ...
  const inner = (
    <>
      <div className="flex items-start justify-between gap-2">
        ...
        {problem.lattice ? (
          <span className="shrink-0 text-[11px] uppercase tracking-[0.14em] text-ok">In Lattice</span>
        ) : (
