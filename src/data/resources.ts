...
export const resources: ResourceLink[] = [
  {
    ...
    blurb:
      "The topic map: load balancers, caches, queues, CDNs, scaling. LetMeLearn's HLD syllabus follows this spine.",
    kind: "roadmap",
  },
  {
  ...
  },
  {
    ...
    blurb:
      "The interactive five-algorithm visualizer that inspired LetMeLearn's rate-limiter lab. HLD + LLD on one page.",
    kind: "playground",
  },
  {
