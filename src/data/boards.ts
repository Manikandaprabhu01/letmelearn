...
const boards: Record<string, ArchitectureBoard> = {
  "scale-to-millions": board(
    ...
    [
      ...
      col("Edge", [
        n("dns", "DNS"),
        n("cdn", "CDN", "static"),
        n("lb", "Load balancer", undefined, "accent"),
      ]),
  ...
  "web-crawler": board(
    ...
    [
      ...
      col("Frontier", [
        n("f", "Per-host queues", undefined, "accent"),
        n("seen", "Seen-URL", "Bloom + store"),
      ]),
  ...
  "news-feed": board(
    ...
    [
      ...
      col("Fan-out", [
        n("w", "Push workers", "normal users", "accent"),
        n("cel", "Celebrity IDs", "pull at read"),
      ]),
  ...
  "email-service": board(
    ...
    [
      ...
      col("Store", [
        n("meta", "Headers + labels", "shard by user", "accent"),
        n("blob", "Body object"),
      ]),
